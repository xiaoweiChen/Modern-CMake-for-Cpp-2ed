...
Actions include APPEND <string>, PREPEND <string>, TOLOWER, TOUPPER, STRIP, GENEX\_STRIP, and REPLACE <pattern> <expression>. They work exactly like the string() modes with the same name.
